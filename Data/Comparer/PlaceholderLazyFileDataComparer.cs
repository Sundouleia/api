...
public class PlaceholderLazyFileDataComparer : IEqualityComparer<PlaceholderLazyFileData>
{
    private static readonly PlaceholderLazyFileDataComparer _instance = new();

    private PlaceholderLazyFileDataComparer()
    { }

    public static PlaceholderLazyFileDataComparer Instance => _instance;

    public bool Equals(PlaceholderLazyFileData? x, PlaceholderLazyFileData? y)
    {
    ...
    public int GetHashCode(PlaceholderLazyFileData obj)
    {
